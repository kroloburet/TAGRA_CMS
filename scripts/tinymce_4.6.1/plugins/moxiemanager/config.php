...
$moxieManagerConfig['general.plugins'] = 'Uploaded,AutoRename';//Favorites,History,Uploaded
...
// Filesystem
$moxieManagerConfig['filesystem.rootpath'] = $_SERVER["DOCUMENT_ROOT"]."/upload";  ///webroot/uploads';
...
$moxieManagerConfig['createdoc.fields'] = '';
...
$moxieManagerConfig['upload.maxsize'] = '4000MB';
...
$moxieManagerConfig['upload.max_height'] = 768;
$moxieManagerConfig['upload.chunk_size'] = '4000MB';
...
$moxieManagerConfig['edit.extensions'] = '*';
...
$moxieManagerConfig['thumbnail.jpeg_quality'] = 50;
