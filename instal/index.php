...
<div id="content">
    ...
    <p>Заполните все поля (одиночные и двойные кавычки не допускаются) и нажмите на кнопку <q>Установить систему</q>
        ...
        увидеть статус установки. Если на этом или другом этапе у вас возникли проблемы &mdash; обратитесь к
        разработчику по e-mail: <a href="mailto:kroloburet@gmail.com">kroloburet@gmail.com</a></p>
