...
<div class="touch" id="administrator_control">
  ...
  <div class="buc_form">
    ...
    Логин <i class="fas fa-info-circle red" onmouseover="TUI.Hint(this)"></i>
    <pre class="hint">
    ...
    Пароль <i class="fas fa-info-circle red" onmouseover="TUI.Hint(this)"></i>
    <pre class="hint">
    ...
    <a href="#" onclick="gen_pass('#ac_pass');return false" class="fas fa-sync-alt" title="Генерировать пароль"></a>
    <label class="input">
      <input type="text" class="buc_pass" id="ac_pass" placeholder="Не заполняйте если не хотите менять пароль">
    </label>
...
<script>
    ...
    ;(function($) {
      ...
      const __get_edit_form = function(id) {
        ...
        _info.html(`<p class="notific_b mini full">
      ...
      const __show = function() {
        ...
        for (let k in _opt) {//заполнять превью
          let edit_btn = $('<div/>', {class: 'buc_prev_edit_btn fas fa-edit', title: 'Редактировать'}).data('id', k),
  ...
  <div class="buc_form" hidden>
    ...
    <div class="row">
      <div class="col6">
        ...
        <a href="#" onclick="gen_pass('#mc_pass');return false" class="fas fa-sync-alt" title="Генерировать пароль"></a>
        <label class="input">
      ...
      <div class="col6">
        ...
        Доступ <i class="fas fa-info-circle blue" onmouseover="TUI.Hint(this)"></i>
        <pre class="hint">
...
<script>
    ...
    ;(function($) {
      ...
      const __show = function() {
        ...
        for (let k in _opt) {// заполнять превью
          let edit_btn = $('<div/>', {class: 'buc_prev_edit_btn fas fa-edit', title: 'Редактировать'}).data('id', k),
              del_btn = $('<div/>', {class: 'buc_prev_del_btn fas fa-trash-alt', title: 'Удалить'}).data('id', k),
              prev_str_box = $('<div/>', {class: 'buc_prev_str_box ' + (_opt[k].access === '0' ? 'red' : ''), html: _opt[k].email}),
