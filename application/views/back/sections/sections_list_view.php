 ...
 <tbody>
  ...
  <tr>
   ...
   <td>
    ...
    <a href="/section/<?=$v['alias']?>" class="fa-external-link" target="_blank" title="Смотреть на сайте"></a>&nbsp;&nbsp;
    <a href="#" class="fa-trash-o red" title="Удалить" onclick="del_section(this,'<?=$v['alias']?>');return false"></a>
   </td>
  </tr>
  <?php }?>
 </tbody>
 ...
 $.ajax({
  ...
  success:function(resp){
   switch(resp){
    ...
    case 'error':alert('Ошибка! Не удалось удалить раздел..(');break;
