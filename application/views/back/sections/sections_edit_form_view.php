...
<h1><?=$conf_title?></h1>
<div class="sheath">
 <form method="POST" action="<?=base_url('admin/section/edit/'.$id.'/'.$alias)?>">
...
<!--####### Комментарии, видимость... #######-->
  ...
  <div class="button this_form_control">
   <button type="button" onclick="subm(form,s_opts)">Сохранить изменения</button><a href="<?=base_url('admin/section/get_list')?>" class="btn_lnk">Отменить</a>
  </div>
 </form>
</div>
<script>
