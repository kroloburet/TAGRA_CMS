...
<div class="sheath">
  <form method="POST" action="/admin/section/add">
    ...
    <div class="touch">
      <h2>Основное</h2>
      <hr>
      Заголовок раздела <i class="fas fa-info-circle red" onmouseover="TUI.Hint(this)"></i>
      <pre class="hint">
    ...
    <div class="button this_form_control">
      <button type="button" onclick="subm(form, req)">Добавить раздел</button>
      <a href="/admin/section/get_list" class="btn_lnk">Отменить</a>
    </div>
  </form>
</div>
