...
<div class="sheath">
 <form method="POST" action="/admin/section/add">
...
<!--####### Комментарии, видимость... #######-->
  ...
  <div class="button this_form_control">
   <button type="button" onclick="subm(form,s_opts)">Добавить раздел</button><a href="/admin/section/get_list" class="btn_lnk">Отменить</a>
  </div>
 </form>
</div>
<script>
