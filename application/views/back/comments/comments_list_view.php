  ...
  <div class="touch">
    <div class="new_comment_header">
      ...
      <div>
        ...
        <span class="fas fa-info-circle blue" onmouseover="TUI.Hint(this)"></span>
        <pre class="hint">
          <b>ID: </b><?= $v['id'] . PHP_EOL ?>
      ...
      <div class="row">
        <div class="col6">
          ...
          <div class="row touch">
            <h2>Вывод</h2>
            <hr>
            Форма комментирования по умолчанию <i class="fas fa-info-circle blue" onmouseover="TUI.Hint(this)"></i>
            <pre class="hint">
            ...
            Зарезервированные имена <i class="fas fa-info-circle blue" onmouseover="TUI.Hint(this)"></i>
            <pre class="hint">
            ...
            Рейтинг комментариев <i class="fas fa-info-circle blue" onmouseover="TUI.Hint(this)"></i>
            <pre class="hint">
            ...
            Лимит в поле <q>Ваше имя</q> <i class="fas fa-info-circle blue" onmouseover="TUI.Hint(this)"></i>
            <pre class="hint">
              Лимит символов в поле <q>Ваше имя</q>
              форм комментирования и ответа.
              Если <q>0</q> &mdash; лимит безграничный.
              <b class="red">Целое, положительное число!</b>
            </pre>
            <label class="input">
              <input name="name_limit" type="number" min="0" value="<?= htmlspecialchars($data['conf']['name_limit']) ?>">
            </label>
            Лимит в поле <q>Ваш комментарий</q> <i class="fas fa-info-circle blue" onmouseover="TUI.Hint(this)"></i>
            <pre class="hint">
            ...
            Кнопка <q>Еще комментарии</q> <i class="fas fa-info-circle blue" onmouseover="TUI.Hint(this)"></i>
            <pre class="hint">
        ...
        <div class="col6">
          ...
          <div class="row touch">
            <h2>Уведомления</h2>
            <hr>
            Уведомления о новых комментариях <i class="fas fa-info-circle blue" onmouseover="TUI.Hint(this)"></i>
            <pre class="hint">
            ...
            Обратная связь с комментатором <i class="fas fa-info-circle blue" onmouseover="TUI.Hint(this)"></i>
            <pre class="hint">
