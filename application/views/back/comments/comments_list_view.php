  ...
  <?php foreach($data['new_comments'] as $v){?>
   <div class="touch">
    ...
    <div class="algn_r">
     ...
     <span class="fa-info-circle blue" onmouseover="tt(this);"></span>
     <pre class="tt">
  <b>ID: </b><?=$v['id'].PHP_EOL?>
    ...
    <div class="row">
     <div class="col6">
      ...
      <div class="row touch">
       <h3>Вывод</h3>
       <hr>
       Форма комментирования по умолчанию <i class="fa-info-circle blue" onmouseover="tt(this);"></i>
       <pre class="tt">
...
материалов.</pre>
       ...
       Зарезервированные имена <i class="fa-info-circle blue" onmouseover="tt(this);"></i>
       <pre class="tt">
...
чувствительна к символам разной локали ([eng A]дмин &ne; админ)</pre>
       ...
       Рейтинг комментариев <i class="fa-info-circle blue" onmouseover="tt(this);"></i>
       <pre class="tt">
Комментарии и ответы могут быть оценены
пользователями <q>лайками</q> и <q>дизлайками</q>.</pre>
       <label class="select">
        <select name="rating">
       ...
       Лимит в поле <q>Ваше имя</q> <i class="fa-info-circle blue" onmouseover="tt(this);"></i>
       <pre class="tt">
...
<b class="red">Целое, положительное число!</b></pre>
       ...
       Лимит в поле <q>Ваш комментарий</q> <i class="fa-info-circle blue" onmouseover="tt(this);"></i>
       <pre class="tt">
...
<b class="red">Целое, положительное число!</b></pre>
       ...
       Кнопка <q>Еще комментарии</q> <i class="fa-info-circle blue" onmouseover="tt(this);"></i>
       <pre class="tt">
...
<b class="red">Целое, положительное число!</b></pre>
     ...
     <div class="col6">
      ...
      <div class="row touch">
       <h3>Уведомления</h3>
       <hr>
       Уведомления о новых комментариях <i class="fa-info-circle blue" onmouseover="tt(this);"></i>
       <pre class="tt">
...
премодерации перед публикацией.</pre>
       ...
       Обратная связь с комментатором <i class="fa-info-circle blue" onmouseover="tt(this);"></i>
       <pre class="tt">
...
Например: <q>pupkin</q> из <q>pupkin@gmail.com</q></pre>
       <label class="select">
   ...
   function build_tree($tree_arr,$pid=0){//построение дерева
    ...
    foreach($tree_arr[$pid] as $v){
     ...
     <tr id="<?=$v['id']?>">
      ...
      <td><?=$v['lang']?></td>
      <td>
       <span class="fa-info-circle blue" onmouseover="tt(this);"></span><pre class="tt" style="max-width:400px;white-space:normal;"><?=$v['comment']?></pre>&nbsp;&nbsp;
       <a href="<?=base_url($v['url'].'#comment_'.$v['id'])?>" target="_blank" class="fa-external-link" title="Перейти к комментарию на странице"></a>&nbsp;&nbsp;
       <a href="#" class="fa-trash-o red" title="Удалить с дочерней ветвью" onclick="del_branch('<?=$v['id']?>','<?=$v['url']?>');
         return false"></a>
      </td>
     </tr>
...
<script>
 var form=$('#filter'),
 req={//рег.выражения для проверки полей
  name_limit:/^\d+$/,
  text_limit:/^\d+$/,
  show:/^\d+$/
 };
