<?php if (ENVIRONMENT === 'development' || ENVIRONMENT === 'testing' || !$conf['site_access']) { ?>
    ...
    <div class="TUI_notice-y" style="margin-top:1.5em">
        ...
        <div id="env_info" hidden>
            <h3>О режимах</h3>
            <hr>
            <p>Данное сообщение сигнализирует о том, что пользовательская часть сайта закрыта (настройка <q>Доступ к
                    сайту</q> на странице <q>Конфигурация</q>) или в файле /index.php значение константы ENVIRONMENT
                задано как <q>development</q> или <q>testing</q>. Если разработчик закончил работу над ресурсом и
                протестировал его, рекомендуется задать значение константы ENVIRONMENT как <q>production</q>. Это
                запретит системе выводить ошибки PHP и базы данных, которыми могут воспользоваться злоумышленники.</p>
