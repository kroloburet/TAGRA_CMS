...
<div class="sheath">
    <form method="POST" action="/admin/gallery/add">
        ...
        <div class="touch">
            <h2>Основное</h2>
            <hr>
            Заголовок галереи <i class="fas fa-info-circle TUI_red" onmouseover="TUI.Hint(this)"></i>
            <pre class="TUI_Hint">
        ...
        <div class="TUI_fieldset this_form_control">
            <button type="button" onclick="subm(form, req)">Добавить галерею</button>
            <a href="/admin/gallery/get_list" class="TUI_btn-link">Отменить</a>
        </div>
    </form>
</div>
