...
<div class="container">
 ...
 <div class="notific_b" id="notific_work_info">Здравствуйте, <?=$conf_status?>!<br>Это короткая справка-рекомендация о том, как начать работу в системе.<br>
  ...
  <div id="work_info" class="opn_cls">
   ...
   <h3>Комментарии</h3>
   <hr>
   <p>Управляйте комментариями Ваших материалов, устанавливайте настройки вывода и уведомлений (в главном меню: Комментарии). Создавая и редактируя материал, Вы можете разрешать или запрещать комментировать материал.</p>
