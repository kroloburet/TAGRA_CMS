...
<nav>
 <ul class="menu">
  ...
  <li><span>Материал</span>
   <ul class="sub_menu">
    <li><a href="/admin/home/get_list">Управление страницами «Главная»</a></li>
    <li><a href="/admin/contact/get_list">Управление страницами «Контакты»</a></li>
  ...
  <li class="user_nav"><span><?=$conf['status']?> &#8801;</span>
   <ul class="sub_menu">
    <li><a href="/" target="_blank">Перейти на сайт</a></li>
    <li><a href="/UI_fraimwork/info.html" target="_blank">О системе</a></li>
...
<div class="container">
 ...
 <div class="notific_b" id="notific_work_info">Здравствуйте, <?=$conf['status']?>!<br>Это короткая справка-рекомендация о том, как начать работу в системе.<br>
