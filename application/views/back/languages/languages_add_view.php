    ...
    <div class="touch">
      ...
      <label class="input">
        <input type="text" name="title"
               placeholder="Пример: UA" onkeyup="TUI.Lim(this, 20)"
               onchange="check_title(this, null, 'languages', 'Язык с таким названием уже существует!\nИзмените название и продолжайте.')">
      </label>

      Тег языка <i class="fas fa-info-circle red" onmouseover="TUI.Hint(this, 'click')"></i>
      <pre class="hint">
      ...
      <label class="select">
        <select name="tag" class="SelectSearch" size="3">
      ...
      <label class="checkbox inline" style="margin:0">
        ...
        Язык по умолчанию
      </label> <i class="fas fa-info-circle blue" onmouseover="TUI.Hint(this)"></i>
      <pre class="hint">
