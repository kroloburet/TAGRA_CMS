...
$lang = [
    ...
    'gallery' => [
        ...
        'paused' => 'Пауза...',
        'error_load' => 'Ошибка! Файл не загружен..(',
        'error_path_img_dir' => 'Неверный путь к каталогу изображений!',
    ...
    'section' => [
        ...
        'sub_galleries_title' => 'Раздел содержит галереи:',
        'more' => 'Подробнее',
    ],
    ...
    'comments' => [
        ...
        'reserved_name_msg' => 'Это имя может использовать только администратор или модератор!<br>Если вы один из них, авторизуйтесь в системе.',
